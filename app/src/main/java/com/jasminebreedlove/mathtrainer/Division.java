...
public class Division extends AppCompatActivity {
    ...
    ArrayList<Float> answerChoices = new ArrayList<Float>();
    ...
    public void beginTimer(View view) {
        ...
        cdt = new CountDownTimer(20100, 1000) {
            ...
            public void onFinish() {
                ...
                Toast.makeText(Division.this, "Time's Up!", Toast.LENGTH_SHORT).show();
    ...
    public void generateQuestion() {
        ...
        float a = randomNum.nextInt(31); // num will be a num b/t 0 and 30
        float b = randomNum.nextInt(31);// num will be a num b/t 0 and 30

        //set the equation text view to these numbers
        problem.setText(Float.toString(a) + " / " + Float.toString(b) + " = ? "); //math operator will change per activity
        ...
        float wrongAnswer; // initialize variable for wrong answer choice options
        ...
        for (int i = 0; i < 4; i++) {
            if (i == correctAnswerLocation) { // if the correct answer will be in this particular spot in list of choices...
                answerChoices.add(a/b); // add the 2 random int's together and store that number in our array
            } else {
        ...
        String btn0txt = numberFormat.format(answerChoices.get(0));
        button0.setText(btn0txt);

        String btn1txt = numberFormat.format(answerChoices.get(1));
        button1.setText(btn1txt);

        String btn2txt = numberFormat.format(answerChoices.get(2));
        button2.setText(btn2txt);

        String btn3txt = numberFormat.format(answerChoices.get(3));
    ...
    public void questionsCount() {
        ...
        if (numOfQuestions < 10) {
            ...
            new AlertDialog.Builder(Division.this).setIcon(android.R.drawable.ic_dialog_info).setTitle("Game Over")
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            pauseTimer();
            new AlertDialog.Builder(Division.this).setIcon(android.R.drawable.ic_dialog_info).setTitle("Exit Game?")
                    .setMessage("Are you sure you want to quit your current game?")
                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Intent i = new Intent(Division.this, MainActivity.class);
                            startActivity(i);
                        }
                    })
