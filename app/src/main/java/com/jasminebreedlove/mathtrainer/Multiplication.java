...
public class Multiplication extends AppCompatActivity {
    ...
    public void beginTimer(View view) {
        ...
        cdt = new CountDownTimer(20100, 1000) {
            ...
            public void onFinish() {
                ...
                Toast.makeText(Multiplication.this, "Time's Up!", Toast.LENGTH_SHORT).show();
    ...
    public void questionsCount() {
        ...
        if (numOfQuestions < 10) {
            ...
            new AlertDialog.Builder(Multiplication.this).setIcon(android.R.drawable.ic_dialog_info).setTitle("Game Over")
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            pauseTimer();
            new AlertDialog.Builder(Multiplication.this).setIcon(android.R.drawable.ic_dialog_info).setTitle("Exit Game?")
                    .setMessage("Are you sure you want to quit your current game?")
                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Intent i = new Intent(Multiplication.this, MainActivity.class);
                            startActivity(i);
                        }
                    })
