...
public class Addition extends AppCompatActivity {
    ...
    public void beginTimer(View view) {
        ...
        cdt = new CountDownTimer(20100, 1000) {
            ...
            public void onFinish() {
                ...
                Toast.makeText(Addition.this, "Time's Up!", Toast.LENGTH_SHORT).show();
    ...
    public void questionsCount() {
        ...
        if (numOfQuestions < 10) {
            ...
            new AlertDialog.Builder(Addition.this).setIcon(android.R.drawable.ic_dialog_info).setTitle("Game Over")
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            pauseTimer();
            new AlertDialog.Builder(Addition.this).setIcon(android.R.drawable.ic_dialog_info).setTitle("Exit Game?")
